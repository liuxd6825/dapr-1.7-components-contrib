...
func newLoadEventRequest(aggregateId string) *eventstorage.LoadEventRequest {
	return &eventstorage.LoadEventRequest{
		TenantId:    "001",
		AggregateId: aggregateId,
	}
}

func newApplyEventRequest(aggregateId string) *eventstorage.ApplyEventsRequest {
	return &eventstorage.ApplyEventsRequest{
		TenantId:      "001",
		AggregateId:   aggregateId,
		AggregateType: "TEST",
		Events: &[]eventstorage.EventDto{
			eventstorage.EventDto{
...
func newCreateEventRequest() *eventstorage.CreateEventRequest {
	return &eventstorage.CreateEventRequest{
		TenantId:      "001",
...
func newDeleteEventRequest(aggregateId string) *eventstorage.DeleteEventRequest {
	return &eventstorage.DeleteEventRequest{
		TenantId:      "001",
		AggregateId:   aggregateId,
		AggregateType: "TEST",
...
func newMongoEventSourcing() (eventstorage.EventStorage, error) {
	...
	err := es.Init(metadata, func() pubsub.Adapter {
		return newAdapter()
	})
	if err != nil {
		return nil, err
